...
$('.select2-icon').select2()
  .on('select2:open', function() {
    setTimeout(function() {
      select_scrollbar = Scrollbar.init(document.getElementsByClassName('select2-results__options')[0], {
        damping: 0.06,
        syncCallbacks: true
      });
    }, 0);
...
function formatState(opt) {
  ...
  if (!optimage) {
    ...
    var $opt = $(
      '<span class="coin-icon"><img src="' + optimage + '" width="20px" /> ' + opt.text.toUpperCase() + '</span>'
    );
    return $opt;
  }
};